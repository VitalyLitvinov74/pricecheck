                                            ...
                                            <li className="list-inline-item">
                                                <div className="notifybar">
                                                    <div className="dropdown">
                                                        <a className="dropdown-toggle infobar-icon" href="#"
                                                           role="button"
                                                            ...
                                                            <ul className="list-unstyled">
                                                                ...
                                                                <span
                                                                    ...
                                                                    <div className="media-body">
                                                                        ...
                                                                        <p><span
                                                                            className="timing">Today, 10:45 AM</span>
                                                                        </p>
                                                                    </div>
                                                                </li>
                                                                <li className="media dropdown-item">
                                                                ...
                                                                <span
                                                                    ...
                                                                    <div className="media-body">
                                                                        <h5 className="action-title">John requested to
                                                                            view
                                                                            wireframe</h5>
                                                                        <p><span
                                                                ...
                                                                <span
                                                                    ...
                                                                    <div className="media-body">
                                                                        <h5 className="action-title">Sports shoes are
                                                                            out of
                                                                            stock</h5>
                                                                        <p><span
